...
### <span style='background-color: lightgreen; padding: 3px;'>_Análisis breve_</span> 
Hay un caso que llama la atención y sería el de Asturias, donde sí que observamos que tiene el mayor índice de depresión siendo una de las Comunidades Autónomas con menor número de horas al año, lo cual nos puede servir para sacar conclusiones, si bien vemos que en Andalucía por el contrario disfrutan de una mayor luz, y sin embargo la tasa de depresión es de las más altas, lo que puede deberse también a otros factores sociales, económicos, etc., aunque sin descartar la teoría de la relación entre la oscuridad y lel padecimiento de depresión. <br>
