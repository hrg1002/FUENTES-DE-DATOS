...
ggplot(tabla_final, aes(x = `Consumo Alcohol`,y = `Prevalencia Depresión`, fill = `Comunidades Autónomas`)) +
...
>>>>>>> 1c7b40a9b22064d5914ef183aef85b3c2a2c39b3
  coord_flip()
...
<<<<<<< HEAD
ggplot(tabla_final, aes(x = `Prevalencia Depresión`, y = `Consumo Alcohol`, color = `Comunidades Autónomas`)) +
...
library(dplyr)
comparacion_2<-full_join(depresion, tabla_salarios, by= "Comunidades.y.Ciudades.Autónomas")
